...
const Card = ({ title, date, body}) => {
  return (
		// <>
		// 	<div className='shadow w-80 h-96 p-5'>
		// 		<h4 className='text-sm font-semibold mb-6 font-roboto w-20'>
		// 			{title}
		// 		</h4>
		// 		<h5 className='text-sm mb-9 font-roboto'>
		// 			{date}
		// 		</h5>
		// 		<p className='text-xs text-gray-600 leadin font-roboto mb-9'>
		// 			{body}
		// 		</p>
		...
		<>
			...
			<div className='shadow transition duration-500 w-80 md:w-52 lg:w-80 h-[500px] p-5 hover:bg-blue-700 hover:text-white text-center m-5'>
				...
				<div className='flex content-center justify-center pb-4 '>
					<h4 className='text-blue-300 text-lg font-bold'>
						{price}
					</h4>
					<h5 className='text-opacity-80 '>
						{period}
					</h5>
				</div>
				<p>{list}</p>
